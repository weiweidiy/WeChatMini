...
using GameManager = TowerDefense.Game.GameManager;
...
namespace TowerDefense.UI
{
    ...
    public class EndGameScreen : MonoBehaviour
    {
        ...
        /// </summary>
        public string levelCompleteText = "守方胜利！";

        public string levelFailedText = "攻防胜利！";
        ...
        public void RestartLevel()
        {
            ...
            assetLoader.LoadSceneAsync(currentSceneName);
        }
